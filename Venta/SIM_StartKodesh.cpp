...
static void onSetup()
{
	SetCurrentTime(DaTi(2019, Nov, 1, 16, 15, 0));
}
//------------------------------------------------
...
//------------------------------------------------
IMPLEMENT_SIMULATOR_SCENARIO(StartKodesh);
